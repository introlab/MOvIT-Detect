...
uint32_t io_timeoutI2C = 3500;
uint32_t io_timeoutSPI = 1500;
uint16_t nbTriesI2C = 0;
uint16_t nbTriesSPI = 0;

// Record the current time to check an upcoming timeout against
#define StartTimeoutI2C() (nbTriesI2C = 0)
#define StartTimeoutSPI() (nbTriesSPI = 0)

// Check if timeout is enabled (set to nonzero value) and has expired
#define CheckTimeoutExpiredI2C() (nbTriesI2C++ >= io_timeoutI2C)
#define CheckTimeoutExpiredSPI() (nbTriesSPI++ >= io_timeoutSPI)
